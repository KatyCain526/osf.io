    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            <span id="wiki" class="anchor"></span>
                    ...
                    <p><strong>The wiki is a versatile tool for interacting with your team or the people who view your work.</strong> Each project and component has a wiki, and you can add more depending on your needs. You can also turn the wiki off completely in the “Select Add-Ons” section of your project settings.
</p>
                    <div class="gs-video embed-responsive embed-responsive-16by9">
                        <div class="embed-responsive-item youtube-loader" id="BWlRGvg3Ro4"></div>
                    </div>
                    <p>The wiki supports collaborative editing. You’re entire team can get online and write together.</p>
                   ...
                   <uo>
                   <li><strong><a href="http://assemble.io/docs/Cheatsheet-Markdown.html">Markdown</a></strong> </li>
                   <li><strong><a href="http://en.wikibooks.org/wiki/LaTeX/Mathematics/">Inline Mathermatics</a></strong> </li></uo>
